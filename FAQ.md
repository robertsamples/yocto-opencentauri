...
Open an issue on GitHub (https://github.com/OpenCentauri/yocto-opencentauri/issues) and provide a brief description of what happened and the steps to reproduce it. Alternatively you can also drop by the #COSMOS_development channel on the opencentauri discord server to let us know.
